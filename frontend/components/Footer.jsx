      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "12px" }}>
              <li>
                <Link href="/" style={{ color: "var(--text-light)", fontSize: "0.925rem", transition: "var(--transition)" }}>
                  Home
                </Link>
              </li>
              <li>
                <Link href="/doctors" style={{ color: "var(--text-light)", fontSize: "0.925rem", transition: "var(--transition)" }}>
                  Find Doctors
                </Link>
              </li>
              <li>
                <Link href="#services" style={{ color: "var(--text-light)", fontSize: "0.925rem", transition: "var(--transition)" }}>
                  Our Services
                </Link>
              </li>
              <li>
                <Link href="#about" style={{ color: "var(--text-light)", fontSize: "0.925rem", transition: "var(--transition)" }}>
                  About MediCare
                </Link>
              </li>
              <li>
                <Link href="/register" style={{ color: "var(--text-light)", fontSize: "0.925rem", transition: "var(--transition)" }}>
                  Doctor Registration
                </Link>
              </li>
            </ul>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "24px" }}>
            <Link href="#" style={{ color: "var(--text-light)", transition: "var(--transition)" }}>
              Privacy Policy
            </Link>
            <Link href="#" style={{ color: "var(--text-light)", transition: "var(--transition)" }}>
              Terms & Conditions
